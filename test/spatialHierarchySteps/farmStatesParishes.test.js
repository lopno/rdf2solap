...
describe("detectSpatialHierarchySteps, farmsStates and parishes", () => {
  ...
  it("should have 10000 mapped bindings", () => {
    expect(farmStateParishRelationJson.results.bindings.length).toBe(10000);
  });
  ...
  it("should find 1993 within bounding box relations", () => {
    ...
    expect(withinRelations).toBe(1993);
  });

  it("should find 1993 with some relation", () => {
